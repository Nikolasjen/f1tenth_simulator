...
private:
    ...
    int nav_mux_idx;
    int brake_mux_idx;
    int mydrive_walker_mux_idx; // my own nodes mux idx
    // ***Add mux index for new planner here - THIS IS AN EXAMPLE***
    // int new_mux_idx;
    ...
    int nav_button_idx;
    int mydrive_button_idx; // my own nodes button idx
    // ***Add button index for new planner here - THIS IS AN EXAMPLE***
    // int new_button_idx;
    ...
    std::string mydrive_key_char; // my own nodes keyboard activation key
    // ***Add key char for new planner here - THIS IS AN EXAMPLE***
    // int new_key_char;
...
public:
    BehaviorController() {
        ...
        n.getParam("mydrive_walker_mux_idx", mydrive_walker_mux_idx); // getting my own nodes mux idx
        // ***Add mux index for new planner here - THIS IS AN EXAMPLE***
        ...
        n.getParam("mydrive_button_idx", mydrive_button_idx); // getting my own nodes button idx
        // ***Add button index for new planner here - THIS IS AN EXAMPLE***
        ...
        n.getParam("mydrive_key_char", mydrive_key_char); // getting my own nodes keyboard activation key
        // ***Add key char for new planner here - THIS IS AN EXAMPLE***
    ...
    void joy_callback(const sensor_msgs::Joy & msg) {
        ...
        } else if (msg.buttons[mydrive_button_idx]) { // This is the logic for toggling my own node
            // mydrive walk
            toggle_mux(mydrive_walker_mux_idx, "Mydrive Walker");
        } 
        // ***Add new else if statement here for new planning method - THIS IS AN EXAMPLE***
    ...
    void key_callback(const std_msgs::String & msg) {
        ...
        if (msg.data == joy_key_char) {
            ...
            // nav
            toggle_mux(nav_mux_idx, "Navigation");
        } else if (msg.data == mydrive_key_char) { // This is the logic for toggling my own node
            // mydrive walker
            toggle_mux(mydrive_walker_mux_idx, "Mydrive Walker");
        } 
        // ***Add new else if statement here for new planning method - THIS IS AN EXAMPLE***
